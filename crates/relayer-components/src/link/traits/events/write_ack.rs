...
use crate::link::traits::packet::{HasIncomingPacketType, HasOutgoingPacketType};
...
*/
pub trait HasWriteAcknowledgementEvent<Chain, Counterparty>
where
    Chain: HasEventType,
{
    /**
...
pub trait CanBuildPacketFromWriteAckEvent<Chain, Counterparty>:
    HasWriteAcknowledgementEvent<Chain, Counterparty> + HasIncomingPacketType<Chain, Counterparty>
where
    Chain: HasEventType,
{
    /**
